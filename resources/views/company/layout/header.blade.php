      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-header wd-200">
          <ul class="list-unstyled user-profile-nav">
            <li><a href="{{ route('view.company.profile')}}"><i class="icon ion-ios-person-outline"></i> View Profile</a></li>
            <li><a href="{{ route('edit.company.profile')}}"><i class="icon ion-ios-download-outline"></i> Edit Profile</a></li>
            <li><a href="{{ route('company.change.password') }}"><i class="icon ion-ios-star-outline"></i>Change Password</a></li>
            <li><a href="{{ route('company.logout')}}"><i class="icon ion-power"></i> Sign Out</a></li>
          </ul>
        </div>
      </div>
    </nav>
  ...
  <div class="tab-content">
    <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="notifications" role="tabpanel">
      <div class="media-list">
        ...
        <a href="{{ route('markReadCompany', ['id' => $notification->id]) }}" class="media-list-link read">
        ...
        <a href="{{ route('markRead', ['id' => $notification->id]) }}" class="media-list-link read" style="background-color:#ADB2BA">
          <div class="media pd-x-20 pd-y-15">
            <img src="{{ $imageUrl }}" class="wd-40 rounded-circle" alt="">
            <div class="media-body">
              <p class="tx-13 mg-b-0 tx-gray-700"><strong class="tx-medium tx-gray-800">{{$notification-> data['data']}}</strong></p>
