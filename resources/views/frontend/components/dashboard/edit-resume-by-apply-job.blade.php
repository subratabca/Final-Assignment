<div class="card pd-20 pd-sm-40">
  ...
  <div class="form-layout">
    <form method="post" action="{{ route('update.resume.by.apply.job', ['resume_id' => $editData->id]) }}" enctype="multipart/form-data" >
      @csrf
      ...
      <div class="row mg-b-25">
        ...
        <div class="col-lg-3">
          <div class="form-group">
            <label class="form-control-label">Present Address Name: <span class="tx-danger">*</span></label>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="form-group">
                ...
                <img src="{{ !empty($editData->profile_picture) ? asset($editData->profile_picture) : asset('upload/no_image.jpg') }}" style="width: 150px; height: 80px;">
              </div>
            </div>
