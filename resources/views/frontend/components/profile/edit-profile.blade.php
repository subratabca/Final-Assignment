<div class="card pd-20 pd-sm-40">
  <h6 class="card-body-title">Edit Employee Information</h6><br>
  ...
  <div class="form-layout">
    <form method="post" action="{{ route('update.profile') }}" enctype="multipart/form-data" >
      ...
      <div class="row mg-b-25">
        ...
        <div class="col-lg-2">
          <div class="form-group">
            ...
            <img src="{{ (!empty($editData->profile_image)) ? asset('upload/user-profile/small/'.$editData->profile_image) : asset('upload/no_image.jpg') }}" style="width: 80px; height: 80px;">
          </div>
        </div>
        @endif
      </div>
      <div class="form-layout-footer">
        ...
        <a href="{{ route('view.profile') }}" class="btn btn-success">Back</a>
      </div>
    </form>
  </div>
</div>
