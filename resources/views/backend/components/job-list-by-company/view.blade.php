<div class="card pd-20 pd-sm-40 mg-t-50">
  ...
  <div><a href="{{ route('job.list') }}" class="btn btn-warning mg-b-10 float-right">Back to Job List</a></div>
    ...
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="card-footer tx-center bg-gray-300">
          ...
          @endif
          <a href="{{ route('job.list')}}" class="btn btn-primary">Back To Job List</a>
        </div>
      </div>
    </div>
